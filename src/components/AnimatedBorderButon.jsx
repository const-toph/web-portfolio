...
export const AnimatedBorderButton = ({children}) => {
  return (
    <button
      className="relative bg-transparent border border-border text-primary
    ...
    group
    font-semibold rounded-full overflow-visible
    px-6 py-3 text-lg
    md:px-8 md:py-4 md:text-lg animated-border"
    >
      {/* Animated SVG Border */}
      <svg
